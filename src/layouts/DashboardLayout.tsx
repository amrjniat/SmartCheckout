...
export default function DashboardLayout() {
 ...
 const handleLogout = () => {
    // 1. مسح رموز التوثيق وبيانات المستخدم المخزنة
    localStorage.removeItem('token'); // ✅ كان sessionStorage
    localStorage.removeItem('user');  // ✅ كان sessionStorage
    localStorage.clear();             // ✅ كان sessionStorage.clear()

    // 2. التوجيه المباشر للصفحة الرئيسية مع استبدال السجل لمنع العودة للخلف
