...
export default function ProductsManagementPage() {
  ...
  // بيانات المنتجات الحقيقية القادمة من قاعدة البيانات (تُملأ عبر useEffect أدناه)
  ...
  useEffect(() => {
    ...
    axiosInstance.get('/Products')
      ...
      .catch((error) => {
        ...
        showToast('❌ تعذر جلب المنتجات من قاعدة البيانات', 'error');
      })
      .finally(() => {
        setIsLoading(false);
      });
  ...
  // ✅ إعادة حساب العدادات الإحصائية تلقائيًا كل ما تتغير مصفوفة المنتجات الحقيقية
  useEffect(() => {
    ...
    animateCounter(total, setCountTotal);
    animateCounter(available, setCountAvailable);
  ...
  const handleSaveProduct = (e: React.FormEvent) => {
    ...
    if (modalMode === 'add') {
      ...
      axiosInstance.post('/Products', newProductPayload)
        .then((response) => {
