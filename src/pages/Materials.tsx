...
//         {/* مساحة المحتوى */}
//         <div className="p-6 space-y-6 bg-gradient-to-b from-slate-50 via-white to-slate-50/70 min-h-screen">
...
//                 {/* إجمالي المنتجات */}
//                 <div className="group relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-4 rounded-2xl border border-blue-100/70 shadow-sm hover:shadow-xl hover:shadow-blue-500/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default">
//                   <div className="absolute -left-6 -top-6 w-24 h-24 bg-blue-400/10 rounded-full blur-2xl group-hover:bg-blue-400/20 transition-colors duration-300"></div>
//                   <div className="space-y-1 relative z-10">
//                     <span className="text-xs font-bold text-blue-400/80">📦 إجمالي المنتجات</span>
//                     <h3 className="text-2xl font-black text-slate-800 transition-all">
//                       {isLoading ? '...' : countTotal.toLocaleString()}
//                     </h3>
//                   </div>
//                   <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md shadow-blue-500/30 flex items-center justify-center text-xl font-bold relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">∑</div>
//                 </div>

//                 {/* متوفرة */}
//                 <div className="group relative bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-4 rounded-2xl border border-emerald-100/70 shadow-sm hover:shadow-xl hover:shadow-emerald-500/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default">
//                   <div className="absolute -left-6 -top-6 w-24 h-24 bg-emerald-400/10 rounded-full blur-2xl group-hover:bg-emerald-400/20 transition-colors duration-300"></div>
//                   <div className="space-y-1 relative z-10">
//                     <span className="text-xs font-bold text-emerald-500/80">🟢 منتجات متوفرة</span>
//                     <h3 className="text-2xl font-black text-emerald-600">
//                       {isLoading ? '...' : countAvailable.toLocaleString()}
//                     </h3>
//                   </div>
//                   <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md shadow-emerald-500/30 flex items-center justify-center text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">✓</div>
//                 </div>

//                 {/* منخفض المخزون */}
//                 <div className="group relative bg-gradient-to-br from-amber-50 via-white to-orange-50 p-4 rounded-2xl border border-amber-100/70 shadow-sm hover:shadow-xl hover:shadow-amber-500/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default">
//                   <div className="absolute -left-6 -top-6 w-24 h-24 bg-amber-400/10 rounded-full blur-2xl group-hover:bg-amber-400/20 transition-colors duration-300"></div>
//                   <div className="space-y-1 relative z-10">
//                     <span className="text-xs font-bold text-amber-500/80">🟠 منخفضة المخزون</span>
//                     <h3 className="text-2xl font-black text-amber-500">
//                       {isLoading ? '...' : countLow.toLocaleString()}
//                     </h3>
//                   </div>
//                   <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-md shadow-amber-500/30 flex items-center justify-center text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">⚠️</div>
//                 </div>

//                 {/* نفدت الكمية */}
//                 <div className="group relative bg-gradient-to-br from-rose-50 via-white to-pink-50 p-4 rounded-2xl border border-rose-100/70 shadow-sm hover:shadow-xl hover:shadow-rose-500/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default">
//                   <div className="absolute -left-6 -top-6 w-24 h-24 bg-rose-400/10 rounded-full blur-2xl group-hover:bg-rose-400/20 transition-colors duration-300"></div>
//                   <div className="space-y-1 relative z-10">
//                     <span className="text-xs font-bold text-rose-500/80">🔴 نفدت الكمية</span>
//                     <h3 className="text-2xl font-black text-rose-600">
//                       {isLoading ? '...' : countOut.toLocaleString()}
//                     </h3>
//                   </div>
//                   <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-500 to-pink-600 text-white shadow-md shadow-rose-500/30 flex items-center justify-center text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">✕</div>
//                 </div>
//               </div>
...
//                   ========================================== */}
//               <div className="bg-white/80 backdrop-blur-sm p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300 space-y-4">
...
//                       className="px-4 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center gap-1.5 shadow-md shadow-blue-500/30 hover:-translate-y-0.5"
//                     >
...
//                     <thead>
//                       <tr className="bg-gradient-to-l from-slate-50 to-white text-slate-500 text-[11px] font-bold border-b border-slate-100 text-right">
          ...
          {activeRole === 'cashier' ? (
            ...
            <>
              {/* ==========================================
                  ...
                  ========================================== */}
             {/* ==========================================
                  القسم الثالث: بطاقات الإحصائيات مع عداد متحرك (Cards) - ألوان داكنة وغنية
                  ========================================== */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                
                {/* إجمالي المنتجات */}
                <div className="group relative bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-200 p-5 sm:p-6 rounded-2xl border border-blue-300/70 shadow-sm hover:shadow-xl hover:shadow-blue-600/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default h-full">
                  <div className="absolute -left-6 -top-6 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-colors duration-300"></div>
                  <div className="space-y-1 relative z-10">
                    <span className="text-sm font-bold text-blue-800 block">📦 إجمالي المنتجات</span>
                    <h3 className="text-2xl sm:text-3xl font-black text-slate-900 transition-all tracking-tight mt-2">
                      {isLoading ? '...' : countTotal.toLocaleString()}
                    </h3>
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-800 text-white shadow-md shadow-blue-600/40 flex items-center justify-center text-lg sm:text-xl font-bold relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">∑</div>
                </div>

                {/* متوفرة */}
                <div className="group relative bg-gradient-to-br from-emerald-100 via-emerald-50 to-teal-200 p-5 sm:p-6 rounded-2xl border border-emerald-300/70 shadow-sm hover:shadow-xl hover:shadow-emerald-600/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default h-full">
                  <div className="absolute -left-6 -top-6 w-24 h-24 bg-emerald-500/10 rounded-full blur-2xl group-hover:bg-emerald-500/20 transition-colors duration-300"></div>
                  <div className="space-y-1 relative z-10">
                    <span className="text-sm font-bold text-emerald-800 block">🟢 منتجات متوفرة</span>
                    <h3 className="text-2xl sm:text-3xl font-black text-emerald-900 tracking-tight mt-2">
                      {isLoading ? '...' : countAvailable.toLocaleString()}
                    </h3>
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-emerald-600 to-teal-800 text-white shadow-md shadow-emerald-600/40 flex items-center justify-center text-lg sm:text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">✓</div>
                </div>

                {/* منخفض المخزون */}
                <div className="group relative bg-gradient-to-br from-amber-100 via-amber-50 to-orange-200 p-5 sm:p-6 rounded-2xl border border-amber-300/70 shadow-sm hover:shadow-xl hover:shadow-amber-600/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default h-full">
                  <div className="absolute -left-6 -top-6 w-24 h-24 bg-amber-500/10 rounded-full blur-2xl group-hover:bg-amber-500/20 transition-colors duration-300"></div>
                  <div className="space-y-1 relative z-10">
                    <span className="text-sm font-bold text-amber-800 block">🟠 منخفضة المخزون</span>
                    <h3 className="text-2xl sm:text-3xl font-black text-amber-900 tracking-tight mt-2">
                      {isLoading ? '...' : countLow.toLocaleString()}
                    </h3>
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-amber-600 to-orange-800 text-white shadow-md shadow-amber-600/40 flex items-center justify-center text-lg sm:text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">⚠️</div>
                </div>

                {/* نفدت الكمية */}
                <div className="group relative bg-gradient-to-br from-rose-100 via-rose-50 to-pink-200 p-5 sm:p-6 rounded-2xl border border-rose-300/70 shadow-sm hover:shadow-xl hover:shadow-rose-600/20 flex items-center justify-between overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-default h-full">
                  <div className="absolute -left-6 -top-6 w-24 h-24 bg-rose-500/10 rounded-full blur-2xl group-hover:bg-rose-500/20 transition-colors duration-300"></div>
                  <div className="space-y-1 relative z-10">
                    <span className="text-sm font-bold text-rose-800 block">🔴 نفدت الكمية</span>
                    <h3 className="text-2xl sm:text-3xl font-black text-rose-900 tracking-tight mt-2">
                      {isLoading ? '...' : countOut.toLocaleString()}
                    </h3>
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-rose-600 to-pink-800 text-white shadow-md shadow-rose-600/40 flex items-center justify-center text-lg sm:text-xl relative z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">✕</div>
                </div>
              </div>
