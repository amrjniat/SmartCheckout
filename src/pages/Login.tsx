          ...
          <div className={`max-w-[440px] w-full mx-auto translate-y-4 fade-in ${mounted ? '' : 'opacity-0'}`}>
            ...
            <div className="bg-white rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 sm:p-10">
              <div className="mb-8 text-center">
                <h2 className="text-[26px] font-bold text-[#0b1c3c] mb-2 leading-tight">تسجيل الدخول</h2>
                <p className="text-sm text-slate-500 font-medium">أدخل بريدك الإلكتروني لتسجيل الدخول إلى لوحة التحكم.</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  <span className="relative">{isSubmitting ? 'جاري تسجيل الدخول...' : 'تسجيل دخول'}</span>
                </button>
              </form>
